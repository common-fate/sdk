...
package ingestv1alpha1connect

import (
	connect "connectrpc.com/connect"
	context "context"
	errors "errors"
	v1alpha1 "github.com/common-fate/sdk/gen/granted/ingest/v1alpha1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	IngestServiceName = "granted.ingest.v1alpha1.IngestService"
)
...
const (
	...
	IngestServiceBatchWriteEventsProcedure = "/granted.ingest.v1alpha1.IngestService/BatchWriteEvents"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	ingestServiceServiceDescriptor                = v1alpha1.File_granted_ingest_v1alpha1_ingest_proto.Services().ByName("IngestService")
	ingestServiceBatchWriteEventsMethodDescriptor = ingestServiceServiceDescriptor.Methods().ByName("BatchWriteEvents")
)

// IngestServiceClient is a client for the granted.ingest.v1alpha1.IngestService service.
...
// NewIngestServiceClient constructs a client for the granted.ingest.v1alpha1.IngestService service.
...
// BatchWriteEvents calls granted.ingest.v1alpha1.IngestService.BatchWriteEvents.
...
// IngestServiceHandler is an implementation of the granted.ingest.v1alpha1.IngestService service.
...
func NewIngestServiceHandler(svc IngestServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/granted.ingest.v1alpha1.IngestService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedIngestServiceHandler) BatchWriteEvents(context.Context, *connect.Request[v1alpha1.BatchWriteEventsRequest]) (*connect.Response[v1alpha1.BatchWriteEventsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("granted.ingest.v1alpha1.IngestService.BatchWriteEvents is not implemented"))
}
