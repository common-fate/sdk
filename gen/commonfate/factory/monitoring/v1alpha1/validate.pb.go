...
var file_commonfate_factory_monitoring_v1alpha1_validate_proto_goTypes = []any{
...
func file_commonfate_factory_monitoring_v1alpha1_validate_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_factory_monitoring_v1alpha1_validate_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_commonfate_factory_monitoring_v1alpha1_validate_proto_msgTypes[1].Exporter = func(v any, i int) any {
