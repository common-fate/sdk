...
var file_commonfate_leastprivilege_v1alpha1_report_proto_goTypes = []any{
...
func file_commonfate_leastprivilege_v1alpha1_report_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_leastprivilege_v1alpha1_report_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Report); i {
			case 0:
				return &v.state
			case 1:
		...
		file_commonfate_leastprivilege_v1alpha1_report_proto_msgTypes[1].Exporter = func(v any, i int) any {
