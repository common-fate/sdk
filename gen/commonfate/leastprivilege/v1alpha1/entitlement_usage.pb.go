...
func file_commonfate_leastprivilege_v1alpha1_entitlement_usage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_leastprivilege_v1alpha1_entitlement_usage_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_commonfate_leastprivilege_v1alpha1_entitlement_usage_proto_msgTypes[1].Exporter = func(v any, i int) any {
