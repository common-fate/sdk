...
func (x *TimeRangeFilter) GetStart() *timestamppb.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *TimeRangeFilter) GetEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
var file_commonfate_filters_v1alpha1_filters_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x52, 0x0a, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x69, 0x73, 0x6f, 0x6e, 0x22, 0x8d,
	0x01, 0x0a, 0x0f, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x46, 0x69, 0x6c, 0x74,
	0x65, 0x72, 0x12, 0x35, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x6d, 0x70, 0x48, 0x01, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x88, 0x01, 0x01, 0x42, 0x08, 0x0a, 0x06,
	0x5f, 0x73, 0x74, 0x61, 0x72, 0x74, 0x42, 0x06, 0x0a, 0x04, 0x5f, 0x65, 0x6e, 0x64, 0x2a, 0x68,
...
var file_commonfate_filters_v1alpha1_filters_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_commonfate_filters_v1alpha1_filters_proto_goTypes = []any{
	...
	(*TimeRangeFilter)(nil),       // 10: commonfate.filters.v1alpha1.TimeRangeFilter
	(v1alpha1.Decision)(0),        // 11: commonfate.authz.v1alpha1.Decision
	(*v1alpha11.EID)(nil),         // 12: commonfate.entity.v1alpha1.EID
	(*timestamppb.Timestamp)(nil), // 13: google.protobuf.Timestamp
}
var file_commonfate_filters_v1alpha1_filters_proto_depIdxs = []int32{
	11, // 0: commonfate.filters.v1alpha1.DecisionFilter.decision:type_name -> commonfate.authz.v1alpha1.Decision
	1,  // 1: commonfate.filters.v1alpha1.TagFilter.comparison:type_name -> commonfate.filters.v1alpha1.BoolComparison
	12, // 2: commonfate.filters.v1alpha1.EntityFilter.ids:type_name -> commonfate.entity.v1alpha1.EID
	...
	13, // 5: commonfate.filters.v1alpha1.OccurredAtFilter.time:type_name -> google.protobuf.Timestamp
	...
	13, // 9: commonfate.filters.v1alpha1.TimeRangeFilter.start:type_name -> google.protobuf.Timestamp
	13, // 10: commonfate.filters.v1alpha1.TimeRangeFilter.end:type_name -> google.protobuf.Timestamp
...
func file_commonfate_filters_v1alpha1_filters_proto_init() {
	...
	file_commonfate_filters_v1alpha1_filters_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
