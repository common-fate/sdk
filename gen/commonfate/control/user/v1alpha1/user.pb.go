...
type QueryUsersResponse struct {
	...
	Resources []*v1alpha1.User `protobuf:"bytes,1,rep,name=resources,proto3" json:"resources,omitempty"`
}
...
func (x *QueryUsersResponse) GetResources() []*v1alpha1.User {
	if x != nil {
		return x.Resources
	}
	return nil
...
func (x *GetUserRequest) GetEid() *v1alpha11.EID {
	if x != nil {
		return x.Eid
	}
	return nil
...
var file_commonfate_control_user_v1alpha1_user_proto_rawDesc = []byte{
	...
	0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x13, 0x0a, 0x11, 0x51, 0x75, 0x65, 0x72, 0x79,
	0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x54, 0x0a, 0x12,
	...
	0x61, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x09, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x73, 0x22, 0x43, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x31, 0x0a, 0x03, 0x65, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x49, 0x44, 0x52, 0x03, 0x65, 0x69, 0x64, 0x22, 0x47, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73,
	0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x34, 0x0a, 0x04, 0x75, 0x73,
	...
	0x32, 0x82, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x7d, 0x0a, 0x0a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x55, 0x73, 0x65, 0x72, 0x73, 0x12, 0x33,
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x66, 0x61, 0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x74,
	0x72, 0x6f, 0x6c, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61,
	...
	0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31,
	...
	0x74, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x30, 0x2e, 0x63, 0x6f, 0x6d,
	...
	0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x31, 0x2e, 0x63,
	0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x66, 0x61, 0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f,
	0x6c, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e,
	0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x04, 0x88, 0xb5, 0x18, 0x01, 0x42, 0xa2, 0x02, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f,
...
var file_commonfate_control_user_v1alpha1_user_proto_goTypes = []interface{}{
	...
	(*v1alpha11.EID)(nil),      // 5: commonfate.entity.v1alpha1.EID
}
var file_commonfate_control_user_v1alpha1_user_proto_depIdxs = []int32{
	4, // 0: commonfate.control.user.v1alpha1.QueryUsersResponse.resources:type_name -> commonfate.access.v1alpha1.User
	5, // 1: commonfate.control.user.v1alpha1.GetUserRequest.eid:type_name -> commonfate.entity.v1alpha1.EID
	4, // 2: commonfate.control.user.v1alpha1.GetUserResponse.user:type_name -> commonfate.access.v1alpha1.User
	0, // 3: commonfate.control.user.v1alpha1.UserService.QueryUsers:input_type -> commonfate.control.user.v1alpha1.QueryUsersRequest
	2, // 4: commonfate.control.user.v1alpha1.UserService.GetUser:input_type -> commonfate.control.user.v1alpha1.GetUserRequest
	1, // 5: commonfate.control.user.v1alpha1.UserService.QueryUsers:output_type -> commonfate.control.user.v1alpha1.QueryUsersResponse
	3, // 6: commonfate.control.user.v1alpha1.UserService.GetUser:output_type -> commonfate.control.user.v1alpha1.GetUserResponse
...
func file_commonfate_control_user_v1alpha1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_control_user_v1alpha1_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_commonfate_control_user_v1alpha1_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_commonfate_control_user_v1alpha1_user_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_commonfate_control_user_v1alpha1_user_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
