...
const (
	...
	PolicyServiceName = "commonfate.control.policy.v1alpha1.PolicyService"
)
...
const (
	...
	// CreatePolicySet RPC.
	PolicyServiceCreatePolicySetProcedure = "/commonfate.control.policy.v1alpha1.PolicyService/CreatePolicySet"
	// PolicyServiceUpdatePolicySetProcedure is the fully-qualified name of the PolicyService's
	// UpdatePolicySet RPC.
	PolicyServiceUpdatePolicySetProcedure = "/commonfate.control.policy.v1alpha1.PolicyService/UpdatePolicySet"
	// PolicyServiceListPolicySetsProcedure is the fully-qualified name of the PolicyService's
	// ListPolicySets RPC.
	PolicyServiceListPolicySetsProcedure = "/commonfate.control.policy.v1alpha1.PolicyService/ListPolicySets"
	// PolicyServiceGetPolicySetProcedure is the fully-qualified name of the PolicyService's
	// GetPolicySet RPC.
	PolicyServiceGetPolicySetProcedure = "/commonfate.control.policy.v1alpha1.PolicyService/GetPolicySet"
	// PolicyServiceDeletePolicySetProcedure is the fully-qualified name of the PolicyService's
	// DeletePolicySet RPC.
	PolicyServiceDeletePolicySetProcedure = "/commonfate.control.policy.v1alpha1.PolicyService/DeletePolicySet"
	// PolicyServiceValidatePolicySetsProcedure is the fully-qualified name of the PolicyService's
	// ValidatePolicySets RPC.
	PolicyServiceValidatePolicySetsProcedure = "/commonfate.control.policy.v1alpha1.PolicyService/ValidatePolicySets"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	policyServiceServiceDescriptor                  = v1alpha1.File_commonfate_control_policy_v1alpha1_policy_proto.Services().ByName("PolicyService")
	...
	policyServiceValidatePolicySetsMethodDescriptor = policyServiceServiceDescriptor.Methods().ByName("ValidatePolicySets")
)

// PolicyServiceClient is a client for the commonfate.control.policy.v1alpha1.PolicyService service.
type PolicyServiceClient interface {
	...
	ValidatePolicySets(context.Context, *connect.Request[v1alpha1.ValidatePolicySetsRequest]) (*connect.Response[v1alpha1.ValidatePolicySetsRequest], error)
}

// NewPolicyServiceClient constructs a client for the
// commonfate.control.policy.v1alpha1.PolicyService service. By default, it uses the Connect
...
func NewPolicyServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) PolicyServiceClient {
	...
	return &policyServiceClient{
		...
		validatePolicySets: connect.NewClient[v1alpha1.ValidatePolicySetsRequest, v1alpha1.ValidatePolicySetsRequest](
			httpClient,
			baseURL+PolicyServiceValidatePolicySetsProcedure,
			connect.WithSchema(policyServiceValidatePolicySetsMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type policyServiceClient struct {
	...
	validatePolicySets *connect.Client[v1alpha1.ValidatePolicySetsRequest, v1alpha1.ValidatePolicySetsRequest]
}

// CreatePolicySet calls commonfate.control.policy.v1alpha1.PolicyService.CreatePolicySet.
...
// UpdatePolicySet calls commonfate.control.policy.v1alpha1.PolicyService.UpdatePolicySet.
...
// ListPolicySets calls commonfate.control.policy.v1alpha1.PolicyService.ListPolicySets.
...
// GetPolicySet calls commonfate.control.policy.v1alpha1.PolicyService.GetPolicySet.
...
// DeletePolicySet calls commonfate.control.policy.v1alpha1.PolicyService.DeletePolicySet.
...
// ValidatePolicySets calls commonfate.control.policy.v1alpha1.PolicyService.ValidatePolicySets.
func (c *policyServiceClient) ValidatePolicySets(ctx context.Context, req *connect.Request[v1alpha1.ValidatePolicySetsRequest]) (*connect.Response[v1alpha1.ValidatePolicySetsRequest], error) {
	return c.validatePolicySets.CallUnary(ctx, req)
}

// PolicyServiceHandler is an implementation of the commonfate.control.policy.v1alpha1.PolicyService
// service.
...
func NewPolicyServiceHandler(svc PolicyServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	policyServiceValidatePolicySetsHandler := connect.NewUnaryHandler(
		PolicyServiceValidatePolicySetsProcedure,
		svc.ValidatePolicySets,
		connect.WithSchema(policyServiceValidatePolicySetsMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	return "/commonfate.control.policy.v1alpha1.PolicyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
		...
		case PolicyServiceValidatePolicySetsProcedure:
			policyServiceValidatePolicySetsHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedPolicyServiceHandler) CreatePolicySet(context.Context, *connect.Request[v1alpha1.CreatePolicySetRequest]) (*connect.Response[v1alpha1.CreatePolicySetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("commonfate.control.policy.v1alpha1.PolicyService.CreatePolicySet is not implemented"))
}
...
func (UnimplementedPolicyServiceHandler) UpdatePolicySet(context.Context, *connect.Request[v1alpha1.UpdatePolicySetRequest]) (*connect.Response[v1alpha1.UpdatePolicySetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("commonfate.control.policy.v1alpha1.PolicyService.UpdatePolicySet is not implemented"))
}
...
func (UnimplementedPolicyServiceHandler) ListPolicySets(context.Context, *connect.Request[v1alpha1.ListPolicySetsRequest]) (*connect.Response[v1alpha1.ListPolicySetsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("commonfate.control.policy.v1alpha1.PolicyService.ListPolicySets is not implemented"))
}
...
func (UnimplementedPolicyServiceHandler) GetPolicySet(context.Context, *connect.Request[v1alpha1.GetPolicySetRequest]) (*connect.Response[v1alpha1.GetPolicySetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("commonfate.control.policy.v1alpha1.PolicyService.GetPolicySet is not implemented"))
}
...
func (UnimplementedPolicyServiceHandler) DeletePolicySet(context.Context, *connect.Request[v1alpha1.DeletePolicySetRequest]) (*connect.Response[v1alpha1.DeletePolicySetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("commonfate.control.policy.v1alpha1.PolicyService.DeletePolicySet is not implemented"))
}

func (UnimplementedPolicyServiceHandler) ValidatePolicySets(context.Context, *connect.Request[v1alpha1.ValidatePolicySetsRequest]) (*connect.Response[v1alpha1.ValidatePolicySetsRequest], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("commonfate.control.policy.v1alpha1.PolicyService.ValidatePolicySets is not implemented"))
}
