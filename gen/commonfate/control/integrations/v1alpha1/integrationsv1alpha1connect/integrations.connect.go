...
import (
	...
	v1alpha1 "github.com/common-fate/sdk/gen/commonfate/control/integrations/v1alpha1"
	http "net/http"
	strings "strings"
)
...
func NewIntegrationServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) IntegrationServiceClient {
	...
	return &integrationServiceClient{
		...
		getGCPIntegration: connect_go.NewClient[v1alpha1.GetGCPIntegrationRequest, v1alpha1.GetGCPIntegrationResponse](
			httpClient,
...
func NewIntegrationServiceHandler(svc IntegrationServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	integrationServiceGetGCPIntegrationHandler := connect_go.NewUnaryHandler(
		IntegrationServiceGetGCPIntegrationProcedure,
