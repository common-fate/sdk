...
import (
	...
	context "context"
	errors "errors"
	v1alpha1 "github.com/common-fate/sdk/gen/commonfate/control/granted/registry/aws/v1alpha1"
	http "net/http"
	strings "strings"
)
...
var (
	profileRegistryServiceServiceDescriptor                           = v1alpha1.File_commonfate_control_granted_registry_aws_v1alpha1_aws_proto.Services().ByName("ProfileRegistryService")
