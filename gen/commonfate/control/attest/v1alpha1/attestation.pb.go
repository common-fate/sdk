...
func file_commonfate_control_attest_v1alpha1_attestation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_control_attest_v1alpha1_attestation_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Header); i {
			case 0:
				return &v.state
			case 1:
		...
		file_commonfate_control_attest_v1alpha1_attestation_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Device); i {
			case 0:
				return &v.state
			case 1:
		...
		file_commonfate_control_attest_v1alpha1_attestation_proto_msgTypes[2].Exporter = func(v any, i int) any {
