...
type Targets struct {
	...
	Type TargetType `protobuf:"varint,1,opt,name=type,proto3,enum=commonfate.control.config.v1alpha1.TargetType" json:"type,omitempty"` //eg GCP:Project
...
var file_commonfate_control_config_v1alpha1_access_selector_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x22, 0x61,
	0x0a, 0x07, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x12, 0x42, 0x0a, 0x04, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x66, 0x61, 0x74, 0x65, 0x2e, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x54, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x12, 0x0a,
	...
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x2a, 0x2b, 0x0a, 0x0a, 0x54, 0x61, 0x72, 0x67, 0x65, 0x74, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x0e, 0x0a, 0x0a, 0x47, 0x43, 0x50, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x10, 0x00, 0x12, 0x0d, 0x0a, 0x09, 0x47, 0x43, 0x50, 0x46, 0x6f, 0x6c, 0x64, 0x65, 0x72,
	0x10, 0x01, 0x32, 0x87, 0x05, 0x0a, 0x15, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65, 0x6c,
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x9b, 0x01, 0x0a,
	0x14, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65, 0x6c,
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x3f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x66, 0x61,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x93, 0x01, 0x0a, 0x12, 0x52,
	0x65, 0x61, 0x64, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f,
...
var file_commonfate_control_config_v1alpha1_access_selector_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_commonfate_control_config_v1alpha1_access_selector_proto_goTypes = []interface{}{
	(TargetType)(0),                      // 0: commonfate.control.config.v1alpha1.TargetType
	(*Targets)(nil),                      // 1: commonfate.control.config.v1alpha1.Targets
	(*CreateAccessSelectorRequest)(nil),  // 2: commonfate.control.config.v1alpha1.CreateAccessSelectorRequest
	(*AccessSelector)(nil),               // 3: commonfate.control.config.v1alpha1.AccessSelector
	(*CreateAccessSelectorResponse)(nil), // 4: commonfate.control.config.v1alpha1.CreateAccessSelectorResponse
	(*GetAccessSelectorRequest)(nil),     // 5: commonfate.control.config.v1alpha1.GetAccessSelectorRequest
	(*GetAccessSelectorResponse)(nil),    // 6: commonfate.control.config.v1alpha1.GetAccessSelectorResponse
	(*UpdateAccessSelectorRequest)(nil),  // 7: commonfate.control.config.v1alpha1.UpdateAccessSelectorRequest
	(*UpdateAccessSelectorResponse)(nil), // 8: commonfate.control.config.v1alpha1.UpdateAccessSelectorResponse
	(*DeleteAccessSelectorRequest)(nil),  // 9: commonfate.control.config.v1alpha1.DeleteAccessSelectorRequest
	(*DeleteAccessSelectorResponse)(nil), // 10: commonfate.control.config.v1alpha1.DeleteAccessSelectorResponse
}
var file_commonfate_control_config_v1alpha1_access_selector_proto_depIdxs = []int32{
	0,  // 0: commonfate.control.config.v1alpha1.Targets.type:type_name -> commonfate.control.config.v1alpha1.TargetType
	1,  // 1: commonfate.control.config.v1alpha1.CreateAccessSelectorRequest.targets:type_name -> commonfate.control.config.v1alpha1.Targets
	1,  // 2: commonfate.control.config.v1alpha1.AccessSelector.targets:type_name -> commonfate.control.config.v1alpha1.Targets
	3,  // 3: commonfate.control.config.v1alpha1.CreateAccessSelectorResponse.selector:type_name -> commonfate.control.config.v1alpha1.AccessSelector
	3,  // 4: commonfate.control.config.v1alpha1.GetAccessSelectorResponse.selector:type_name -> commonfate.control.config.v1alpha1.AccessSelector
	3,  // 5: commonfate.control.config.v1alpha1.UpdateAccessSelectorRequest.selector:type_name -> commonfate.control.config.v1alpha1.AccessSelector
	3,  // 6: commonfate.control.config.v1alpha1.UpdateAccessSelectorResponse.workflow:type_name -> commonfate.control.config.v1alpha1.AccessSelector
	3,  // 7: commonfate.control.config.v1alpha1.DeleteAccessSelectorResponse.selector:type_name -> commonfate.control.config.v1alpha1.AccessSelector
	2,  // 8: commonfate.control.config.v1alpha1.AccessSelectorService.CreateAccessSelector:input_type -> commonfate.control.config.v1alpha1.CreateAccessSelectorRequest
	5,  // 9: commonfate.control.config.v1alpha1.AccessSelectorService.ReadAccessSelector:input_type -> commonfate.control.config.v1alpha1.GetAccessSelectorRequest
	7,  // 10: commonfate.control.config.v1alpha1.AccessSelectorService.UpdateAccessSelector:input_type -> commonfate.control.config.v1alpha1.UpdateAccessSelectorRequest
	9,  // 11: commonfate.control.config.v1alpha1.AccessSelectorService.DeleteAccessSelector:input_type -> commonfate.control.config.v1alpha1.DeleteAccessSelectorRequest
	4,  // 12: commonfate.control.config.v1alpha1.AccessSelectorService.CreateAccessSelector:output_type -> commonfate.control.config.v1alpha1.CreateAccessSelectorResponse
	6,  // 13: commonfate.control.config.v1alpha1.AccessSelectorService.ReadAccessSelector:output_type -> commonfate.control.config.v1alpha1.GetAccessSelectorResponse
	8,  // 14: commonfate.control.config.v1alpha1.AccessSelectorService.UpdateAccessSelector:output_type -> commonfate.control.config.v1alpha1.UpdateAccessSelectorResponse
	10, // 15: commonfate.control.config.v1alpha1.AccessSelectorService.DeleteAccessSelector:output_type -> commonfate.control.config.v1alpha1.DeleteAccessSelectorResponse
