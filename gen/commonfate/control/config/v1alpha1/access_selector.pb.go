...
func (x *UpdateAccessSelectorRequest) GetDiagnostics() []*v1alpha11.Diagnostic {
	if x != nil {
		return x.Diagnostics
	}
	return nil
...
var file_commonfate_control_config_v1alpha1_access_selector_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0xb7, 0x01, 0x0a, 0x1b, 0x55,
	...
	0x74, 0x69, 0x63, 0x73, 0x22, 0x6e, 0x0a, 0x1c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63,
	...
	0x63, 0x74, 0x6f, 0x72, 0x22, 0x2d, 0x0a, 0x1b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x41, 0x63,
...
var file_commonfate_control_config_v1alpha1_access_selector_proto_depIdxs = []int32{
	...
	10, // 6: commonfate.control.config.v1alpha1.UpdateAccessSelectorRequest.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	1,  // 7: commonfate.control.config.v1alpha1.UpdateAccessSelectorResponse.selector:type_name -> commonfate.control.config.v1alpha1.AccessSelector
