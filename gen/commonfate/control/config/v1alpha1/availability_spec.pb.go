...
func (x *AvailabilitySpec) GetPriority() int32 {
	if x != nil {
		return x.Priority
	}
	return 0
...
func (x *CreateAvailabilitySpecRequest) GetPriority() int32 {
	if x != nil {
		return x.Priority
	}
	return 0
...
var file_commonfate_control_config_v1alpha1_availability_spec_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x08, 0x70, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0x94, 0x02, 0x0a, 0x1d,
