...
var file_commonfate_control_integration_v1alpha1_integration_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x22, 0x8d, 0x03, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x40,
	...
	0x08, 0x6f, 0x70, 0x73, 0x67, 0x65, 0x6e, 0x69, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x63, 0x6f, 0x6e,
...
var file_commonfate_control_integration_v1alpha1_integration_proto_goTypes = []interface{}{
	...
	(*v1alpha1.Diagnostic)(nil),       // 18: commonfate.access.v1alpha1.Diagnostic
}
var file_commonfate_control_integration_v1alpha1_integration_proto_depIdxs = []int32{
	...
	0,  // 7: commonfate.control.integration.v1alpha1.Integration.status:type_name -> commonfate.control.integration.v1alpha1.Status
	18, // 8: commonfate.control.integration.v1alpha1.Integration.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	4,  // 9: commonfate.control.integration.v1alpha1.Integration.config:type_name -> commonfate.control.integration.v1alpha1.Config
	5,  // 10: commonfate.control.integration.v1alpha1.CreateIntegrationResponse.integration:type_name -> commonfate.control.integration.v1alpha1.Integration
	5,  // 11: commonfate.control.integration.v1alpha1.GetIntegrationResponse.integration:type_name -> commonfate.control.integration.v1alpha1.Integration
	5,  // 12: commonfate.control.integration.v1alpha1.UpdateIntegrationRequest.integration:type_name -> commonfate.control.integration.v1alpha1.Integration
	5,  // 13: commonfate.control.integration.v1alpha1.UpdateIntegrationResponse.integration:type_name -> commonfate.control.integration.v1alpha1.Integration
	3,  // 14: commonfate.control.integration.v1alpha1.IntegrationService.CreateIntegration:input_type -> commonfate.control.integration.v1alpha1.CreateIntegrationRequest
	9,  // 15: commonfate.control.integration.v1alpha1.IntegrationService.UpdateIntegration:input_type -> commonfate.control.integration.v1alpha1.UpdateIntegrationRequest
	7,  // 16: commonfate.control.integration.v1alpha1.IntegrationService.GetIntegration:input_type -> commonfate.control.integration.v1alpha1.GetIntegrationRequest
	11, // 17: commonfate.control.integration.v1alpha1.IntegrationService.DeleteIntegration:input_type -> commonfate.control.integration.v1alpha1.DeleteIntegrationRequest
	1,  // 18: commonfate.control.integration.v1alpha1.IntegrationService.ListIntegrations:input_type -> commonfate.control.integration.v1alpha1.ListIntegrationsRequest
