...
type S3LogDestination struct {
	...
	// to in the bucket.
	//
	// For example: '{{ .Year }}/{{ .Month }}/{{ .Day }}/{{ .ID }}.json'
	//
	// Available template parameters are:
	// Year - the year the event occurred in YYYY format, e.g. 2024
	// Month - the month the event occurred in MM format, e.g. 01
	// Day - the calendar day the event in DD format, e.g. 15
	// ID - the event ID, e.g. evt_2gWnmOeMcvy9qkqiztqVySw5OMf
	AuditLogKeyTemplate string `protobuf:"bytes,3,opt,name=audit_log_key_template,json=auditLogKeyTemplate,proto3" json:"audit_log_key_template,omitempty"`
}
...
func (x *S3LogDestination) GetAuditLogKeyTemplate() string {
	if x != nil {
		return x.AuditLogKeyTemplate
	}
	return ""
}
...
var file_commonfate_control_integration_v1alpha1_s3_log_destination_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x22, 0x83, 0x01, 0x0a, 0x10,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x41, 0x72, 0x6e, 0x12, 0x33, 0x0a, 0x16,
	0x61, 0x75, 0x64, 0x69, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x74, 0x65,
	0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x61, 0x75,
	0x64, 0x69, 0x74, 0x4c, 0x6f, 0x67, 0x4b, 0x65, 0x79, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74,
	0x65, 0x42, 0xdf, 0x02, 0x0a, 0x2b, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	...
	0x31, 0x42, 0x15, 0x53, 0x33, 0x4c, 0x6f, 0x67, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74,
