...
type AWSEKSCluster struct {
	...
	Users                 []*AWSEKSClusterUser `protobuf:"bytes,7,rep,name=users,proto3" json:"users,omitempty"`
}
...
func (x *AWSEKSCluster) GetUsers() []*AWSEKSClusterUser {
	if x != nil {
		return x.Users
	}
	return nil
...
func (x *AWSEKSClusterUser) Reset() {
	*x = AWSEKSClusterUser{}
...
func (x *AWSEKSClusterUser) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AWSEKSClusterUser) ProtoMessage() {}

func (x *AWSEKSClusterUser) ProtoReflect() protoreflect.Message {
	mi := &file_commonfate_control_integration_v1alpha1_proxy_resource_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AWSEKSClusterUser.ProtoReflect.Descriptor instead.
func (*AWSEKSClusterUser) Descriptor() ([]byte, []int) {
	return file_commonfate_control_integration_v1alpha1_proxy_resource_proto_rawDescGZIP(), []int{4}
}

func (x *AWSEKSClusterUser) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AWSEKSClusterUser) GetServiceAccountName() string {
	if x != nil {
...
var file_commonfate_control_integration_v1alpha1_proxy_resource_proto_rawDesc = []byte{
	...
	0x09, 0x5f, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0xa5, 0x02, 0x0a, 0x0d, 0x41,
	...
	,
	...
	0x63, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0xdc, 0x02,
...
var file_commonfate_control_integration_v1alpha1_proxy_resource_proto_goTypes = []any{
	...
	(*AWSEKSClusterUser)(nil),  // 4: commonfate.control.integration.v1alpha1.AWSEKSClusterUser
}
var file_commonfate_control_integration_v1alpha1_proxy_resource_proto_depIdxs = []int32{
	...
	4, // 3: commonfate.control.integration.v1alpha1.AWSEKSCluster.users:type_name -> commonfate.control.integration.v1alpha1.AWSEKSClusterUser
