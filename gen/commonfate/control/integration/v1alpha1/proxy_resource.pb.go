...
type AWSEKSCluster struct {
	...
	Name    string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Region  string `protobuf:"bytes,3,opt,name=region,proto3" json:"region,omitempty"`
	Account string `protobuf:"bytes,4,opt,name=account,proto3" json:"account,omitempty"` // TODO
}
...
var file_commonfate_control_integration_v1alpha1_proxy_resource_proto_rawDesc = []byte{
	...
	0x09, 0x5f, 0x65, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0x55, 0x0a, 0x0d, 0x41, 0x57,
	0x53, 0x45, 0x4b, 0x53, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12,
	...
	0x74, 0x42, 0xdc, 0x02, 0x0a, 0x2b, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
...
var file_commonfate_control_integration_v1alpha1_proxy_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
