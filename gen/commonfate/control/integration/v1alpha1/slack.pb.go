...
var file_commonfate_control_integration_v1alpha1_slack_proto_goTypes = []any{
...
func file_commonfate_control_integration_v1alpha1_slack_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_control_integration_v1alpha1_slack_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Slack); i {
			case 0:
				return &v.state
			case 1:
