...
var (
	proxyHealthCheckServiceServiceDescriptor    = v1alpha1.File_commonfate_control_integration_v1alpha1_healthcheck_proto.Services().ByName("ProxyHealthCheckService")
