...
func file_commonfate_control_integration_v1alpha1_healthcheck_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_control_integration_v1alpha1_healthcheck_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_commonfate_control_integration_v1alpha1_healthcheck_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_commonfate_control_integration_v1alpha1_healthcheck_proto_msgTypes[2].Exporter = func(v any, i int) any {
