...
import (
	...
	context "context"
	errors "errors"
	v1alpha1 "github.com/common-fate/sdk/gen/commonfate/deployment/diagnostic/v1alpha1"
	http "net/http"
	strings "strings"
)
...
var (
	diagnosticServiceServiceDescriptor                     = v1alpha1.File_commonfate_deployment_diagnostic_v1alpha1_diagnostic_proto.Services().ByName("DiagnosticService")
