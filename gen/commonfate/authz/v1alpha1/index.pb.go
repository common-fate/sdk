...
func (x *Relation) GetPrincipal() *v1alpha1.UID {
	if x != nil {
		return x.Principal
	}
	return nil
...
func (x *Relation) GetAction() *v1alpha1.UID {
	if x != nil {
		return x.Action
	}
	return nil
...
func (x *Relation) GetResource() *v1alpha1.UID {
	if x != nil {
		return x.Resource
	}
	return nil
...
type LookupResourcesRequest struct {
	...
	Principal *v1alpha1.UID `protobuf:"bytes,3,opt,name=principal,proto3" json:"principal,omitempty"`
...
func (x *LookupResourcesRequest) GetPrincipal() *v1alpha1.UID {
	if x != nil {
		return x.Principal
	}
	return nil
...
type AllowedAction struct {
	...
	Action *v1alpha1.UID `protobuf:"bytes,1,opt,name=action,proto3" json:"action,omitempty"`
}
...
func (x *AllowedAction) GetAction() *v1alpha1.UID {
	if x != nil {
		return x.Action
	}
	return nil
...
var file_commonfate_authz_v1alpha1_index_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x74, 0x79, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f, 0x75, 0x69,
	...
	0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x55, 0x49, 0x44, 0x52, 0x09, 0x70, 0x72, 0x69,
	...
	0x68, 0x61, 0x31, 0x2e, 0x55, 0x49, 0x44, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x70, 0x68, 0x61, 0x31, 0x2e, 0x55, 0x49, 0x44, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
...
var file_commonfate_authz_v1alpha1_index_proto_depIdxs = []int32{
	...
	10, // 2: commonfate.authz.v1alpha1.Relation.principal:type_name -> commonfate.entity.v1alpha1.UID
	10, // 3: commonfate.authz.v1alpha1.Relation.action:type_name -> commonfate.entity.v1alpha1.UID
	10, // 4: commonfate.authz.v1alpha1.Relation.resource:type_name -> commonfate.entity.v1alpha1.UID
	...
	10, // 7: commonfate.authz.v1alpha1.LookupResourcesRequest.principal:type_name -> commonfate.entity.v1alpha1.UID
	...
	10, // 10: commonfate.authz.v1alpha1.AllowedAction.action:type_name -> commonfate.entity.v1alpha1.UID
