...
func file_commonfate_authz_v1alpha1_request_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_authz_v1alpha1_request_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_commonfate_authz_v1alpha1_request_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Tag); i {
			case 0:
				return &v.state
			case 1:
