...
type QueryGrantsRequest struct {
	...
	Principal *Specifier `protobuf:"bytes,2,opt,name=principal,proto3" json:"principal,omitempty"`
	Target    *Specifier `protobuf:"bytes,3,opt,name=target,proto3" json:"target,omitempty"`
	Role      *Specifier `protobuf:"bytes,4,opt,name=role,proto3" json:"role,omitempty"`
}
...
func (x *QueryGrantsRequest) GetPrincipal() *Specifier {
	if x != nil {
		return x.Principal
	}
	return nil
...
func (x *QueryGrantsRequest) GetTarget() *Specifier {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *QueryGrantsRequest) GetRole() *Specifier {
	if x != nil {
		return x.Role
	}
	return nil
...
var file_commonfate_access_v1alpha1_grants_proto_rawDesc = []byte{
	...
	0x61, 0x31, 0x2f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0xf2, 0x01, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x73, 0x52,
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x43, 0x0a, 0x09, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70,
	0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x66, 0x61, 0x74, 0x65, 0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2e, 0x76, 0x31, 0x61,
	...
	0x72, 0x6f, 0x6c, 0x65, 0x22, 0x78, 0x0a, 0x13, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x72, 0x61,
	...
	0x6e, 0x32, 0x89, 0x02, 0x0a, 0x0d, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x73, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x70, 0x0a, 0x0b, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x72, 0x61, 0x6e,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x85, 0x01, 0x0a, 0x12, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47,
	0x72, 0x61, 0x6e, 0x74, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e, 0x12, 0x35, 0x2e, 0x63,
	...
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x43, 0x68, 0x69, 0x6c, 0x64,
	0x72, 0x65, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x81, 0x02,
	0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x66, 0x61, 0x74, 0x65,
	0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
	0x42, 0x0b, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
...
var file_commonfate_access_v1alpha1_grants_proto_goTypes = []interface{}{
	...
	(*Grant)(nil),                      // 5: commonfate.access.v1alpha1.Grant
	(*v1alpha1.Entity)(nil),            // 6: commonfate.entity.v1alpha1.Entity
}
var file_commonfate_access_v1alpha1_grants_proto_depIdxs = []int32{
	4, // 0: commonfate.access.v1alpha1.QueryGrantsRequest.principal:type_name -> commonfate.access.v1alpha1.Specifier
	4, // 1: commonfate.access.v1alpha1.QueryGrantsRequest.target:type_name -> commonfate.access.v1alpha1.Specifier
	4, // 2: commonfate.access.v1alpha1.QueryGrantsRequest.role:type_name -> commonfate.access.v1alpha1.Specifier
	5, // 3: commonfate.access.v1alpha1.QueryGrantsResponse.grants:type_name -> commonfate.access.v1alpha1.Grant
	6, // 4: commonfate.access.v1alpha1.QueryGrantChildrenResponse.entities:type_name -> commonfate.entity.v1alpha1.Entity
	0, // 5: commonfate.access.v1alpha1.GrantsService.QueryGrants:input_type -> commonfate.access.v1alpha1.QueryGrantsRequest
	2, // 6: commonfate.access.v1alpha1.GrantsService.QueryGrantChildren:input_type -> commonfate.access.v1alpha1.QueryGrantChildrenRequest
	1, // 7: commonfate.access.v1alpha1.GrantsService.QueryGrants:output_type -> commonfate.access.v1alpha1.QueryGrantsResponse
	3, // 8: commonfate.access.v1alpha1.GrantsService.QueryGrantChildren:output_type -> commonfate.access.v1alpha1.QueryGrantChildrenResponse
