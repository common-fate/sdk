...
var file_commonfate_access_v1alpha1_diagnostic_proto_goTypes = []any{
...
func file_commonfate_access_v1alpha1_diagnostic_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_access_v1alpha1_diagnostic_proto_msgTypes[0].Exporter = func(v any, i int) any {
