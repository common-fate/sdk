...
var file_commonfate_access_v1alpha1_integration_audit_logs_proto_goTypes = []any{
...
func file_commonfate_access_v1alpha1_integration_audit_logs_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_access_v1alpha1_integration_audit_logs_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_commonfate_access_v1alpha1_integration_audit_logs_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_commonfate_access_v1alpha1_integration_audit_logs_proto_msgTypes[2].Exporter = func(v any, i int) any {
