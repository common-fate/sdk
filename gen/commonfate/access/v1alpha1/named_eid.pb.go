...
var file_commonfate_access_v1alpha1_named_eid_proto_goTypes = []interface{}{
...
func file_commonfate_access_v1alpha1_named_eid_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_commonfate_access_v1alpha1_named_eid_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NamedEID); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
