...
var file_commonfate_access_v1alpha1_access_proto_rawDesc = []byte{
	...
	0x52, 0x0c, 0x72, 0x6f, 0x6c, 0x65, 0x50, 0x72, 0x69, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x22, 0xd9,
...
var file_commonfate_access_v1alpha1_access_proto_depIdxs = []int32{
	...
	28, // 31: commonfate.access.v1alpha1.Specifier.eid:type_name -> commonfate.entity.v1alpha1.EID
	...
	33, // 35: commonfate.access.v1alpha1.EntitlementInput.duration:type_name -> google.protobuf.Duration
	21, // 36: commonfate.access.v1alpha1.BatchEnsureRequest.entitlements:type_name -> commonfate.access.v1alpha1.EntitlementInput
	34, // 37: commonfate.access.v1alpha1.BatchEnsureRequest.justification:type_name -> commonfate.access.v1alpha1.Justification
	25, // 38: commonfate.access.v1alpha1.BatchEnsureResponse.grants:type_name -> commonfate.access.v1alpha1.GrantState
	26, // 39: commonfate.access.v1alpha1.BatchEnsureResponse.validation:type_name -> commonfate.access.v1alpha1.Validation
	35, // 40: commonfate.access.v1alpha1.BatchEnsureResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	24, // 41: commonfate.access.v1alpha1.BatchEnsureResponse.duration_configuration:type_name -> commonfate.access.v1alpha1.DurationConfiguration
	33, // 42: commonfate.access.v1alpha1.DurationConfiguration.default_duration:type_name -> google.protobuf.Duration
	33, // 43: commonfate.access.v1alpha1.DurationConfiguration.max_duration:type_name -> google.protobuf.Duration
	36, // 44: commonfate.access.v1alpha1.GrantState.grant:type_name -> commonfate.access.v1alpha1.Grant
	0,  // 45: commonfate.access.v1alpha1.GrantState.change:type_name -> commonfate.access.v1alpha1.GrantChange
	32, // 46: commonfate.access.v1alpha1.EntitlementNode.NamedEid:type_name -> commonfate.access.v1alpha1.NamedEID
	27, // 47: commonfate.access.v1alpha1.EntitlementNode.children:type_name -> commonfate.access.v1alpha1.EntitlementNode
	32, // 48: commonfate.access.v1alpha1.EntitlementNode.parent:type_name -> commonfate.access.v1alpha1.NamedEID
	32, // 49: commonfate.access.v1alpha1.EntitlementNode.roles:type_name -> commonfate.access.v1alpha1.NamedEID
	32, // 50: commonfate.access.v1alpha1.EntitlementNode.suggested_role:type_name -> commonfate.access.v1alpha1.NamedEID
	22, // 51: commonfate.access.v1alpha1.AccessService.BatchEnsure:input_type -> commonfate.access.v1alpha1.BatchEnsureRequest
	4,  // 52: commonfate.access.v1alpha1.AccessService.QueryAvailabilities:input_type -> commonfate.access.v1alpha1.QueryAvailabilitiesRequest
	6,  // 53: commonfate.access.v1alpha1.AccessService.QueryEntitlements:input_type -> commonfate.access.v1alpha1.QueryEntitlementsRequest
	1,  // 54: commonfate.access.v1alpha1.AccessService.QueryApprovers:input_type -> commonfate.access.v1alpha1.QueryApproversRequest
	10, // 55: commonfate.access.v1alpha1.AccessService.PreviewUserAccess:input_type -> commonfate.access.v1alpha1.PreviewUserAccessRequest
	12, // 56: commonfate.access.v1alpha1.AccessService.PreviewEntitlementAccess:input_type -> commonfate.access.v1alpha1.PreviewEntitlementAccessRequest
	14, // 57: commonfate.access.v1alpha1.AccessService.DebugEntitlementAccess:input_type -> commonfate.access.v1alpha1.DebugEntitlementAccessRequest
	8,  // 58: commonfate.access.v1alpha1.AccessService.QueryEntitlementsTree:input_type -> commonfate.access.v1alpha1.QueryEntitlementsTreeRequest
	23, // 59: commonfate.access.v1alpha1.AccessService.BatchEnsure:output_type -> commonfate.access.v1alpha1.BatchEnsureResponse
	5,  // 60: commonfate.access.v1alpha1.AccessService.QueryAvailabilities:output_type -> commonfate.access.v1alpha1.QueryAvailabilitiesResponse
	7,  // 61: commonfate.access.v1alpha1.AccessService.QueryEntitlements:output_type -> commonfate.access.v1alpha1.QueryEntitlementsResponse
	3,  // 62: commonfate.access.v1alpha1.AccessService.QueryApprovers:output_type -> commonfate.access.v1alpha1.QueryApproversResponse
	11, // 63: commonfate.access.v1alpha1.AccessService.PreviewUserAccess:output_type -> commonfate.access.v1alpha1.PreviewUserAccessResponse
	13, // 64: commonfate.access.v1alpha1.AccessService.PreviewEntitlementAccess:output_type -> commonfate.access.v1alpha1.PreviewEntitlementAccessResponse
	15, // 65: commonfate.access.v1alpha1.AccessService.DebugEntitlementAccess:output_type -> commonfate.access.v1alpha1.DebugEntitlementAccessResponse
	9,  // 66: commonfate.access.v1alpha1.AccessService.QueryEntitlementsTree:output_type -> commonfate.access.v1alpha1.QueryEntitlementsTreeResponse
