...
type QueryAvailabilitiesLiteRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *QueryAvailabilitiesLiteRequest) Reset() {
	*x = QueryAvailabilitiesLiteRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryAvailabilitiesLiteRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryAvailabilitiesLiteRequest) ProtoMessage() {}

func (x *QueryAvailabilitiesLiteRequest) ProtoReflect() protoreflect.Message {
	mi := &file_commonfate_access_v1alpha1_access_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryAvailabilitiesLiteRequest.ProtoReflect.Descriptor instead.
func (*QueryAvailabilitiesLiteRequest) Descriptor() ([]byte, []int) {
	return file_commonfate_access_v1alpha1_access_proto_rawDescGZIP(), []int{2}
}

func (x *QueryAvailabilitiesLiteRequest) GetPageToken() string {
	if x != nil {
		return x.PageToken
	}
	return ""
...
type QueryAvailabilitiesLiteResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Availabilities []*AvailabilityLite `protobuf:"bytes,1,rep,name=availabilities,proto3" json:"availabilities,omitempty"`
	NextPageToken  string              `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}

func (x *QueryAvailabilitiesLiteResponse) Reset() {
	*x = QueryAvailabilitiesLiteResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *QueryAvailabilitiesLiteResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryAvailabilitiesLiteResponse) ProtoMessage() {}

func (x *QueryAvailabilitiesLiteResponse) ProtoReflect() protoreflect.Message {
	mi := &file_commonfate_access_v1alpha1_access_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryAvailabilitiesLiteResponse.ProtoReflect.Descriptor instead.
func (*QueryAvailabilitiesLiteResponse) Descriptor() ([]byte, []int) {
	return file_commonfate_access_v1alpha1_access_proto_rawDescGZIP(), []int{3}
}

func (x *QueryAvailabilitiesLiteResponse) GetAvailabilities() []*AvailabilityLite {
	if x != nil {
		return x.Availabilities
	}
	return nil
...
func (x *QueryAvailabilitiesLiteResponse) GetNextPageToken() string {
	if x != nil {
		return x.NextPageToken
	}
	return ""
...
func (x *AvailabilityLite) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AvailabilityLite) ProtoMessage() {}

func (x *AvailabilityLite) ProtoReflect() protoreflect.Message {
	mi := &file_commonfate_access_v1alpha1_access_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AvailabilityLite.ProtoReflect.Descriptor instead.
func (*AvailabilityLite) Descriptor() ([]byte, []int) {
	return file_commonfate_access_v1alpha1_access_proto_rawDescGZIP(), []int{4}
}

func (x *AvailabilityLite) GetTarget() *NamedEID {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *AvailabilityLite) GetRole() *NamedEID {
	if x != nil {
		return x.Role
	}
	return nil
...
var file_commonfate_access_v1alpha1_access_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x3f, 0x0a, 0x1e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41,
	0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x4c, 0x69, 0x74,
	0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x65,
	0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x61,
	0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x9f, 0x01, 0x0a, 0x1f, 0x51, 0x75, 0x65, 0x72,
	0x79, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x4c,
	0x69, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x54, 0x0a, 0x0e, 0x61,
	...
	0x2e, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x4c, 0x69, 0x74,
	0x65, 0x52, 0x0e, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65,
	0x73, 0x12, 0x26, 0x0a, 0x0f, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x70, 0x61, 0x67, 0x65, 0x5f, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6e, 0x65, 0x78, 0x74,
	0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8a, 0x01, 0x0a, 0x10, 0x41, 0x76,
	0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x4c, 0x69, 0x74, 0x65, 0x12, 0x3c,
	...
	0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x93, 0x03, 0x0a, 0x0c, 0x41, 0x76, 0x61, 0x69, 0x6c,
	...
	0x32, 0xab, 0x03, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0xb5, 0x18, 0x01, 0x12, 0x98, 0x01, 0x0a, 0x17, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x76, 0x61,
	0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x4c, 0x69, 0x74, 0x65, 0x12,
	...
	0x4c, 0x69, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x3b, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x66, 0x61, 0x74, 0x65, 0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2e,
	0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x76,
	0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x4c, 0x69, 0x74, 0x65,
...
var file_commonfate_access_v1alpha1_access_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_commonfate_access_v1alpha1_access_proto_goTypes = []interface{}{
	...
	(*QueryAvailabilitiesLiteRequest)(nil),  // 3: commonfate.access.v1alpha1.QueryAvailabilitiesLiteRequest
	(*QueryAvailabilitiesLiteResponse)(nil), // 4: commonfate.access.v1alpha1.QueryAvailabilitiesLiteResponse
	(*AvailabilityLite)(nil),                // 5: commonfate.access.v1alpha1.AvailabilityLite
	(*Availability)(nil),                    // 6: commonfate.access.v1alpha1.Availability
	(*Specifier)(nil),                       // 7: commonfate.access.v1alpha1.Specifier
	(*EntitlementInput)(nil),                // 8: commonfate.access.v1alpha1.EntitlementInput
	(*BatchEnsureRequest)(nil),              // 9: commonfate.access.v1alpha1.BatchEnsureRequest
	(*BatchEnsureResponse)(nil),             // 10: commonfate.access.v1alpha1.BatchEnsureResponse
	(*GrantState)(nil),                      // 11: commonfate.access.v1alpha1.GrantState
	...
	(*Grant)(nil),                           // 17: commonfate.access.v1alpha1.Grant
}
var file_commonfate_access_v1alpha1_access_proto_depIdxs = []int32{
	6,  // 0: commonfate.access.v1alpha1.QueryAvailabilitiesResponse.availabilities:type_name -> commonfate.access.v1alpha1.Availability
	5,  // 1: commonfate.access.v1alpha1.QueryAvailabilitiesLiteResponse.availabilities:type_name -> commonfate.access.v1alpha1.AvailabilityLite
	12, // 2: commonfate.access.v1alpha1.AvailabilityLite.target:type_name -> commonfate.access.v1alpha1.NamedEID
	12, // 3: commonfate.access.v1alpha1.AvailabilityLite.role:type_name -> commonfate.access.v1alpha1.NamedEID
	12, // 4: commonfate.access.v1alpha1.Availability.target:type_name -> commonfate.access.v1alpha1.NamedEID
	12, // 5: commonfate.access.v1alpha1.Availability.role:type_name -> commonfate.access.v1alpha1.NamedEID
	13, // 6: commonfate.access.v1alpha1.Availability.duration:type_name -> google.protobuf.Duration
	14, // 7: commonfate.access.v1alpha1.Availability.reviewers:type_name -> commonfate.entity.v1alpha1.EID
	14, // 8: commonfate.access.v1alpha1.Availability.target_selector:type_name -> commonfate.entity.v1alpha1.EID
	14, // 9: commonfate.access.v1alpha1.Specifier.eid:type_name -> commonfate.entity.v1alpha1.EID
	7,  // 10: commonfate.access.v1alpha1.EntitlementInput.principal:type_name -> commonfate.access.v1alpha1.Specifier
	7,  // 11: commonfate.access.v1alpha1.EntitlementInput.target:type_name -> commonfate.access.v1alpha1.Specifier
	7,  // 12: commonfate.access.v1alpha1.EntitlementInput.role:type_name -> commonfate.access.v1alpha1.Specifier
	13, // 13: commonfate.access.v1alpha1.EntitlementInput.duration:type_name -> google.protobuf.Duration
	8,  // 14: commonfate.access.v1alpha1.BatchEnsureRequest.entitlements:type_name -> commonfate.access.v1alpha1.EntitlementInput
	15, // 15: commonfate.access.v1alpha1.BatchEnsureRequest.justification:type_name -> commonfate.access.v1alpha1.Justification
	11, // 16: commonfate.access.v1alpha1.BatchEnsureResponse.grants:type_name -> commonfate.access.v1alpha1.GrantState
	16, // 17: commonfate.access.v1alpha1.BatchEnsureResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	17, // 18: commonfate.access.v1alpha1.GrantState.grant:type_name -> commonfate.access.v1alpha1.Grant
	0,  // 19: commonfate.access.v1alpha1.GrantState.change:type_name -> commonfate.access.v1alpha1.GrantChange
	9,  // 20: commonfate.access.v1alpha1.AccessService.BatchEnsure:input_type -> commonfate.access.v1alpha1.BatchEnsureRequest
	1,  // 21: commonfate.access.v1alpha1.AccessService.QueryAvailabilities:input_type -> commonfate.access.v1alpha1.QueryAvailabilitiesRequest
	3,  // 22: commonfate.access.v1alpha1.AccessService.QueryAvailabilitiesLite:input_type -> commonfate.access.v1alpha1.QueryAvailabilitiesLiteRequest
	10, // 23: commonfate.access.v1alpha1.AccessService.BatchEnsure:output_type -> commonfate.access.v1alpha1.BatchEnsureResponse
	2,  // 24: commonfate.access.v1alpha1.AccessService.QueryAvailabilities:output_type -> commonfate.access.v1alpha1.QueryAvailabilitiesResponse
	4,  // 25: commonfate.access.v1alpha1.AccessService.QueryAvailabilitiesLite:output_type -> commonfate.access.v1alpha1.QueryAvailabilitiesLiteResponse
...
func file_commonfate_access_v1alpha1_access_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_commonfate_access_v1alpha1_access_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryAvailabilitiesLiteRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_commonfate_access_v1alpha1_access_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryAvailabilitiesLiteResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
