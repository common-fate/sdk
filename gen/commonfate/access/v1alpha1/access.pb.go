...
type QueryEntitlementsResponse struct {
	...
	Availabilities []*Entitlement `protobuf:"bytes,1,rep,name=availabilities,proto3" json:"availabilities,omitempty"`
	NextPageToken  string         `protobuf:"bytes,2,opt,name=next_page_token,json=nextPageToken,proto3" json:"next_page_token,omitempty"`
}
...
func (x *QueryEntitlementsResponse) GetAvailabilities() []*Entitlement {
	if x != nil {
		return x.Availabilities
	}
	return nil
...
var file_commonfate_access_v1alpha1_access_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x39, 0x0a, 0x18, 0x51, 0x75, 0x65, 0x72, 0x79, 0x45,
	...
	0x6e, 0x22, 0x94, 0x01, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x45, 0x6e, 0x74, 0x69, 0x74,
	0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x4f, 0x0a, 0x0e, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65,
	...
	0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x85, 0x01, 0x0a, 0x0b, 0x45, 0x6e, 0x74,
...
var file_commonfate_access_v1alpha1_access_proto_depIdxs = []int32{
	...
	5,  // 1: commonfate.access.v1alpha1.QueryEntitlementsResponse.availabilities:type_name -> commonfate.access.v1alpha1.Entitlement
