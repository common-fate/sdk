...
func (x *GrantState) GetValidation() *Validation {
	if x != nil {
		return x.Validation
	}
	return nil
...
var file_commonfate_access_v1alpha1_access_proto_rawDesc = []byte{
	...
	0x63, 0x52, 0x0b, 0x64, 0x69, 0x61, 0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0xce,
	...
	0x06, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x46, 0x0a, 0x0a, 0x76, 0x61, 0x6c, 0x69, 0x64,
...
var file_commonfate_access_v1alpha1_access_proto_depIdxs = []int32{
	...
	23, // 41: commonfate.access.v1alpha1.GrantState.validation:type_name -> commonfate.access.v1alpha1.Validation
