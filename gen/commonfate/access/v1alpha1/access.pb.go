...
var file_commonfate_access_v1alpha1_access_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x39, 0x0a, 0x18, 0x51, 0x75, 0x65, 0x72,
	...
	0x6b, 0x65, 0x6e, 0x22, 0x90, 0x01, 0x0a, 0x19, 0x51, 0x75, 0x65, 0x72, 0x79, 0x45, 0x6e, 0x74,
	...
	0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x5b, 0x0a, 0x1a, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65,
	0x77, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x3d, 0x0a, 0x09, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61,
	0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	0x66, 0x61, 0x74, 0x65, 0x2e, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x31, 0x2e, 0x45, 0x49, 0x44, 0x52, 0x09, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69,
	0x70, 0x61, 0x6c, 0x22, 0x6a, 0x0a, 0x1b, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x45, 0x6e,
	...
	0x49, 0x4c, 0x45, 0x44, 0x10, 0x04, 0x32, 0xa7, 0x05, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x65, 0x73,
...
var file_commonfate_access_v1alpha1_access_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_commonfate_access_v1alpha1_access_proto_goTypes = []interface{}{
	...
	(*Entitlement)(nil),                 // 9: commonfate.access.v1alpha1.Entitlement
	(*Availability)(nil),                // 10: commonfate.access.v1alpha1.Availability
	(*Specifier)(nil),                   // 11: commonfate.access.v1alpha1.Specifier
	(*EntitlementInput)(nil),            // 12: commonfate.access.v1alpha1.EntitlementInput
	(*BatchEnsureRequest)(nil),          // 13: commonfate.access.v1alpha1.BatchEnsureRequest
	(*BatchEnsureResponse)(nil),         // 14: commonfate.access.v1alpha1.BatchEnsureResponse
	(*GrantState)(nil),                  // 15: commonfate.access.v1alpha1.GrantState
	(*v1alpha1.EID)(nil),                // 16: commonfate.entity.v1alpha1.EID
	(*User)(nil),                        // 17: commonfate.access.v1alpha1.User
	(*NamedEID)(nil),                    // 18: commonfate.access.v1alpha1.NamedEID
...
var file_commonfate_access_v1alpha1_access_proto_depIdxs = []int32{
	16, // 0: commonfate.access.v1alpha1.QueryApproversRequest.target:type_name -> commonfate.entity.v1alpha1.EID
	16, // 1: commonfate.access.v1alpha1.QueryApproversRequest.role:type_name -> commonfate.entity.v1alpha1.EID
	17, // 2: commonfate.access.v1alpha1.QueryApproversResponse.approvers:type_name -> commonfate.access.v1alpha1.User
	10, // 3: commonfate.access.v1alpha1.QueryAvailabilitiesResponse.availabilities:type_name -> commonfate.access.v1alpha1.Availability
	9,  // 4: commonfate.access.v1alpha1.QueryEntitlementsResponse.entitlements:type_name -> commonfate.access.v1alpha1.Entitlement
	16, // 5: commonfate.access.v1alpha1.PreviewEntitlementsRequest.principal:type_name -> commonfate.entity.v1alpha1.EID
	9,  // 6: commonfate.access.v1alpha1.PreviewEntitlementsResponse.entitlements:type_name -> commonfate.access.v1alpha1.Entitlement
	18, // 7: commonfate.access.v1alpha1.Entitlement.target:type_name -> commonfate.access.v1alpha1.NamedEID
	18, // 8: commonfate.access.v1alpha1.Entitlement.role:type_name -> commonfate.access.v1alpha1.NamedEID
	18, // 9: commonfate.access.v1alpha1.Availability.target:type_name -> commonfate.access.v1alpha1.NamedEID
	18, // 10: commonfate.access.v1alpha1.Availability.role:type_name -> commonfate.access.v1alpha1.NamedEID
	19, // 11: commonfate.access.v1alpha1.Availability.duration:type_name -> google.protobuf.Duration
	16, // 12: commonfate.access.v1alpha1.Availability.reviewers:type_name -> commonfate.entity.v1alpha1.EID
	16, // 13: commonfate.access.v1alpha1.Availability.target_selector:type_name -> commonfate.entity.v1alpha1.EID
	16, // 14: commonfate.access.v1alpha1.Specifier.eid:type_name -> commonfate.entity.v1alpha1.EID
	11, // 15: commonfate.access.v1alpha1.EntitlementInput.principal:type_name -> commonfate.access.v1alpha1.Specifier
	11, // 16: commonfate.access.v1alpha1.EntitlementInput.target:type_name -> commonfate.access.v1alpha1.Specifier
	11, // 17: commonfate.access.v1alpha1.EntitlementInput.role:type_name -> commonfate.access.v1alpha1.Specifier
	19, // 18: commonfate.access.v1alpha1.EntitlementInput.duration:type_name -> google.protobuf.Duration
	12, // 19: commonfate.access.v1alpha1.BatchEnsureRequest.entitlements:type_name -> commonfate.access.v1alpha1.EntitlementInput
	20, // 20: commonfate.access.v1alpha1.BatchEnsureRequest.justification:type_name -> commonfate.access.v1alpha1.Justification
	15, // 21: commonfate.access.v1alpha1.BatchEnsureResponse.grants:type_name -> commonfate.access.v1alpha1.GrantState
	21, // 22: commonfate.access.v1alpha1.BatchEnsureResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	22, // 23: commonfate.access.v1alpha1.GrantState.grant:type_name -> commonfate.access.v1alpha1.Grant
	0,  // 24: commonfate.access.v1alpha1.GrantState.change:type_name -> commonfate.access.v1alpha1.GrantChange
	13, // 25: commonfate.access.v1alpha1.AccessService.BatchEnsure:input_type -> commonfate.access.v1alpha1.BatchEnsureRequest
	3,  // 26: commonfate.access.v1alpha1.AccessService.QueryAvailabilities:input_type -> commonfate.access.v1alpha1.QueryAvailabilitiesRequest
	5,  // 27: commonfate.access.v1alpha1.AccessService.QueryEntitlements:input_type -> commonfate.access.v1alpha1.QueryEntitlementsRequest
	1,  // 28: commonfate.access.v1alpha1.AccessService.QueryApprovers:input_type -> commonfate.access.v1alpha1.QueryApproversRequest
	7,  // 29: commonfate.access.v1alpha1.AccessService.PreviewEntitlements:input_type -> commonfate.access.v1alpha1.PreviewEntitlementsRequest
	14, // 30: commonfate.access.v1alpha1.AccessService.BatchEnsure:output_type -> commonfate.access.v1alpha1.BatchEnsureResponse
	4,  // 31: commonfate.access.v1alpha1.AccessService.QueryAvailabilities:output_type -> commonfate.access.v1alpha1.QueryAvailabilitiesResponse
	6,  // 32: commonfate.access.v1alpha1.AccessService.QueryEntitlements:output_type -> commonfate.access.v1alpha1.QueryEntitlementsResponse
	2,  // 33: commonfate.access.v1alpha1.AccessService.QueryApprovers:output_type -> commonfate.access.v1alpha1.QueryApproversResponse
	8,  // 34: commonfate.access.v1alpha1.AccessService.PreviewEntitlements:output_type -> commonfate.access.v1alpha1.PreviewEntitlementsResponse
