...
type BatchEnsureResponse struct {
	...
	Changes        []GrantChange    `protobuf:"varint,9,rep,packed,name=changes,proto3,enum=commonfate.access.v1alpha1.GrantChange" json:"changes,omitempty"`
...
func (x *BatchEnsureResponse) GetChanges() []GrantChange {
	if x != nil {
		return x.Changes
	}
	return nil
...
func (x *BatchEnsureResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_commonfate_access_v1alpha1_access_proto_rawDesc = []byte{
	...
	0xab, 0x02, 0x0a, 0x13, 0x42, 0x61, 0x74, 0x63, 0x68, 0x45, 0x6e, 0x73, 0x75, 0x72, 0x65, 0x52,
	...
	0x12, 0x41, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28,
	...
	0x72, 0x61, 0x6e, 0x74, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x86, 0x01,
	...
	0x4e, 0x49, 0x4e, 0x47, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x04, 0x32, 0x8c, 0x02,
...
var file_commonfate_access_v1alpha1_access_proto_depIdxs = []int32{
	...
	0,  // 14: commonfate.access.v1alpha1.BatchEnsureResponse.changes:type_name -> commonfate.access.v1alpha1.GrantChange
