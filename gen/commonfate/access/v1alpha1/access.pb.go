...
var file_commonfate_access_v1alpha1_access_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0xc3, 0x02, 0x0a, 0x0f, 0x45, 0x6e, 0x74, 0x69,
	...
	0x01, 0x01, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x2a, 0xa4, 0x01,
...
var file_commonfate_access_v1alpha1_access_proto_depIdxs = []int32{
	...
	22, // 46: commonfate.access.v1alpha1.AccessService.BatchEnsure:input_type -> commonfate.access.v1alpha1.BatchEnsureRequest
	4,  // 47: commonfate.access.v1alpha1.AccessService.QueryAvailabilities:input_type -> commonfate.access.v1alpha1.QueryAvailabilitiesRequest
	6,  // 48: commonfate.access.v1alpha1.AccessService.QueryEntitlements:input_type -> commonfate.access.v1alpha1.QueryEntitlementsRequest
	1,  // 49: commonfate.access.v1alpha1.AccessService.QueryApprovers:input_type -> commonfate.access.v1alpha1.QueryApproversRequest
	10, // 50: commonfate.access.v1alpha1.AccessService.PreviewUserAccess:input_type -> commonfate.access.v1alpha1.PreviewUserAccessRequest
	12, // 51: commonfate.access.v1alpha1.AccessService.PreviewEntitlementAccess:input_type -> commonfate.access.v1alpha1.PreviewEntitlementAccessRequest
	14, // 52: commonfate.access.v1alpha1.AccessService.DebugEntitlementAccess:input_type -> commonfate.access.v1alpha1.DebugEntitlementAccessRequest
	8,  // 53: commonfate.access.v1alpha1.AccessService.QueryEntitlementsTree:input_type -> commonfate.access.v1alpha1.QueryEntitlementsTreeRequest
	23, // 54: commonfate.access.v1alpha1.AccessService.BatchEnsure:output_type -> commonfate.access.v1alpha1.BatchEnsureResponse
	5,  // 55: commonfate.access.v1alpha1.AccessService.QueryAvailabilities:output_type -> commonfate.access.v1alpha1.QueryAvailabilitiesResponse
	7,  // 56: commonfate.access.v1alpha1.AccessService.QueryEntitlements:output_type -> commonfate.access.v1alpha1.QueryEntitlementsResponse
	3,  // 57: commonfate.access.v1alpha1.AccessService.QueryApprovers:output_type -> commonfate.access.v1alpha1.QueryApproversResponse
	11, // 58: commonfate.access.v1alpha1.AccessService.PreviewUserAccess:output_type -> commonfate.access.v1alpha1.PreviewUserAccessResponse
	13, // 59: commonfate.access.v1alpha1.AccessService.PreviewEntitlementAccess:output_type -> commonfate.access.v1alpha1.PreviewEntitlementAccessResponse
	15, // 60: commonfate.access.v1alpha1.AccessService.DebugEntitlementAccess:output_type -> commonfate.access.v1alpha1.DebugEntitlementAccessResponse
	9,  // 61: commonfate.access.v1alpha1.AccessService.QueryEntitlementsTree:output_type -> commonfate.access.v1alpha1.QueryEntitlementsTreeResponse
