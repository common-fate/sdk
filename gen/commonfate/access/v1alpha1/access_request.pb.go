...
type QueryAccessRequestsRequest struct {
	...
	RequestedBy *v1alpha1.EID   `protobuf:"bytes,4,opt,name=requested_by,json=requestedBy,proto3,oneof" json:"requested_by,omitempty"`
	...
	GrantStatus GrantStatus     `protobuf:"varint,7,opt,name=grant_status,json=grantStatus,proto3,enum=commonfate.access.v1alpha1.GrantStatus" json:"grant_status,omitempty"`
}
...
func (x *QueryAccessRequestsRequest) GetGrantStatus() GrantStatus {
	if x != nil {
...
var file_commonfate_access_v1alpha1_access_request_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xed, 0x03, 0x0a, 0x1a, 0x51, 0x75,
	...
	0x01, 0x12, 0x47, 0x0a, 0x0c, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x62,
	...
	,
	...
	0x74, 0x75, 0x73, 0x52, 0x0b, 0x67, 0x72, 0x61, 0x6e, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x42, 0x08, 0x0a, 0x06, 0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x42, 0x0c, 0x0a, 0x0a, 0x5f,
	0x63, 0x6c, 0x6f, 0x73, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x61, 0x70,
	0x70, 0x72, 0x6f, 0x76, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x22, 0x99, 0x01, 0x0a, 0x1b, 0x51, 0x75,
	0x65, 0x72, 0x79, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x6e, 0x32, 0xed, 0x06, 0x0a, 0x14, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75,
...
var file_commonfate_access_v1alpha1_access_request_proto_goTypes = []any{
	...
	(*Diagnostic)(nil),                      // 21: commonfate.access.v1alpha1.Diagnostic
}
var file_commonfate_access_v1alpha1_access_request_proto_depIdxs = []int32{
	...
	16, // 1: commonfate.access.v1alpha1.QueryAccessRequestsRequest.requested_by:type_name -> commonfate.entity.v1alpha1.EID
	16, // 2: commonfate.access.v1alpha1.QueryAccessRequestsRequest.closed_by:type_name -> commonfate.entity.v1alpha1.EID
	16, // 3: commonfate.access.v1alpha1.QueryAccessRequestsRequest.approved_by:type_name -> commonfate.entity.v1alpha1.EID
	17, // 4: commonfate.access.v1alpha1.QueryAccessRequestsRequest.grant_status:type_name -> commonfate.access.v1alpha1.GrantStatus
	6,  // 5: commonfate.access.v1alpha1.QueryAccessRequestsResponse.access_requests:type_name -> commonfate.access.v1alpha1.AccessRequest
	6,  // 6: commonfate.access.v1alpha1.GetAccessRequestResponse.access_request:type_name -> commonfate.access.v1alpha1.AccessRequest
	7,  // 7: commonfate.access.v1alpha1.GetAccessRequestActionsResponse.access_request_actions:type_name -> commonfate.access.v1alpha1.AccessRequestActions
	18, // 8: commonfate.access.v1alpha1.AccessRequest.grants:type_name -> commonfate.access.v1alpha1.Grant
	19, // 9: commonfate.access.v1alpha1.AccessRequest.created_at:type_name -> google.protobuf.Timestamp
	14, // 10: commonfate.access.v1alpha1.AccessRequest.justification:type_name -> commonfate.access.v1alpha1.Justification
	20, // 11: commonfate.access.v1alpha1.AccessRequest.principal:type_name -> commonfate.access.v1alpha1.User
	21, // 12: commonfate.access.v1alpha1.ApproveAccessRequestResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	21, // 13: commonfate.access.v1alpha1.CloseAccessRequestResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	21, // 14: commonfate.access.v1alpha1.ActivateAccessRequestResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	0,  // 15: commonfate.access.v1alpha1.AccessRequestService.QueryAccessRequests:input_type -> commonfate.access.v1alpha1.QueryAccessRequestsRequest
	2,  // 16: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequest:input_type -> commonfate.access.v1alpha1.GetAccessRequestRequest
	4,  // 17: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequestActions:input_type -> commonfate.access.v1alpha1.GetAccessRequestActionsRequest
	8,  // 18: commonfate.access.v1alpha1.AccessRequestService.ApproveAccessRequest:input_type -> commonfate.access.v1alpha1.ApproveAccessRequestRequest
	12, // 19: commonfate.access.v1alpha1.AccessRequestService.ActivateAccessRequest:input_type -> commonfate.access.v1alpha1.ActivateAccessRequestRequest
	10, // 20: commonfate.access.v1alpha1.AccessRequestService.CloseAccessRequest:input_type -> commonfate.access.v1alpha1.CloseAccessRequestRequest
	1,  // 21: commonfate.access.v1alpha1.AccessRequestService.QueryAccessRequests:output_type -> commonfate.access.v1alpha1.QueryAccessRequestsResponse
	3,  // 22: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequest:output_type -> commonfate.access.v1alpha1.GetAccessRequestResponse
	5,  // 23: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequestActions:output_type -> commonfate.access.v1alpha1.GetAccessRequestActionsResponse
	9,  // 24: commonfate.access.v1alpha1.AccessRequestService.ApproveAccessRequest:output_type -> commonfate.access.v1alpha1.ApproveAccessRequestResponse
	13, // 25: commonfate.access.v1alpha1.AccessRequestService.ActivateAccessRequest:output_type -> commonfate.access.v1alpha1.ActivateAccessRequestResponse
	11, // 26: commonfate.access.v1alpha1.AccessRequestService.CloseAccessRequest:output_type -> commonfate.access.v1alpha1.CloseAccessRequestResponse
