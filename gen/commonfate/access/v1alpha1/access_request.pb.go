...
type AccessRequest struct {
	...
	Justification *JustificationDetail `protobuf:"bytes,9,opt,name=justification,proto3" json:"justification,omitempty"`
...
func (x *AccessRequest) GetJustification() *JustificationDetail {
	if x != nil {
...
type Justification struct {
	...
	Attachments []*AttachmentSpecifier `protobuf:"bytes,2,rep,name=attachments,proto3" json:"attachments,omitempty"`
}
...
func (x *Justification) GetAttachments() []*AttachmentSpecifier {
	if x != nil {
...
func (x *Attachment) GetIntegrationId() string {
	if x != nil {
...
type AttachmentSpecifier struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*AttachmentSpecifier_Attachment
	//	*AttachmentSpecifier_Lookup
	Specify isAttachmentSpecifier_Specify `protobuf_oneof:"specify"`
}

func (x *AttachmentSpecifier) Reset() {
	*x = AttachmentSpecifier{}
	mi := &file_commonfate_access_v1alpha1_access_request_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AttachmentSpecifier) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttachmentSpecifier) ProtoMessage() {}

func (x *AttachmentSpecifier) ProtoReflect() protoreflect.Message {
	mi := &file_commonfate_access_v1alpha1_access_request_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttachmentSpecifier.ProtoReflect.Descriptor instead.
func (*AttachmentSpecifier) Descriptor() ([]byte, []int) {
	return file_commonfate_access_v1alpha1_access_request_proto_rawDescGZIP(), []int{20}
}

func (m *AttachmentSpecifier) GetSpecify() isAttachmentSpecifier_Specify {
	if m != nil {
		return m.Specify
	}
	return nil
...
func (x *AttachmentSpecifier) GetAttachment() *Attachment {
	if x, ok := x.GetSpecify().(*AttachmentSpecifier_Attachment); ok {
		return x.Attachment
	}
	return nil
}

func (x *AttachmentSpecifier) GetLookup() string {
	if x, ok := x.GetSpecify().(*AttachmentSpecifier_Lookup); ok {
		return x.Lookup
	}
	return ""
}

type isAttachmentSpecifier_Specify interface {
	isAttachmentSpecifier_Specify()
}

type AttachmentSpecifier_Attachment struct {
	// Specify an attachment by ID, if you know the exact attachment you should use this.
	Attachment *Attachment `protobuf:"bytes,1,opt,name=attachment,proto3,oneof"`
}

type AttachmentSpecifier_Lookup struct {
	// Specify an attachment using a lookup by id across all attachment integrations. This is used in our CLI
	// to allow end users to look up an attachment for any integration by ID or URL.
	//
	// If the lookup fails to match in any attachment integration, the API will return a Not Found error.
...
func (*AttachmentSpecifier_Attachment) isAttachmentSpecifier_Specify() {}

func (*AttachmentSpecifier_Lookup) isAttachmentSpecifier_Specify() {}

// detailed justification for an existing request
type JustificationDetail struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Reason      *string             `protobuf:"bytes,1,opt,name=reason,proto3,oneof" json:"reason,omitempty"`
	Attachments []*AttachmentDetail `protobuf:"bytes,2,rep,name=attachments,proto3" json:"attachments,omitempty"`
}

func (x *JustificationDetail) Reset() {
	*x = JustificationDetail{}
	mi := &file_commonfate_access_v1alpha1_access_request_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *JustificationDetail) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JustificationDetail) ProtoMessage() {}

func (x *JustificationDetail) ProtoReflect() protoreflect.Message {
	mi := &file_commonfate_access_v1alpha1_access_request_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JustificationDetail.ProtoReflect.Descriptor instead.
func (*JustificationDetail) Descriptor() ([]byte, []int) {
	return file_commonfate_access_v1alpha1_access_request_proto_rawDescGZIP(), []int{21}
}

func (x *JustificationDetail) GetReason() string {
	if x != nil && x.Reason != nil {
		return *x.Reason
	}
	return ""
...
func (x *JustificationDetail) GetAttachments() []*AttachmentDetail {
	if x != nil {
		return x.Attachments
	}
	return nil
...
func (x *AttachmentDetail) Reset() {
	*x = AttachmentDetail{}
	mi := &file_commonfate_access_v1alpha1_access_request_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AttachmentDetail) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AttachmentDetail) ProtoMessage() {}

func (x *AttachmentDetail) ProtoReflect() protoreflect.Message {
	mi := &file_commonfate_access_v1alpha1_access_request_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AttachmentDetail.ProtoReflect.Descriptor instead.
func (*AttachmentDetail) Descriptor() ([]byte, []int) {
	return file_commonfate_access_v1alpha1_access_request_proto_rawDescGZIP(), []int{22}
}

func (x *AttachmentDetail) GetType() AttachmentType {
	if x != nil {
		return x.Type
	}
	return AttachmentType_ATTACHMENT_TYPE_UNSPECIFIED
...
func (x *AttachmentDetail) GetIntegrationId() string {
	if x != nil {
		return x.IntegrationId
	}
	return ""
...
func (x *AttachmentDetail) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *AttachmentDetail) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *AttachmentDetail) GetSummary() string {
	if x != nil {
		return x.Summary
	}
	return ""
...
var file_commonfate_access_v1alpha1_access_request_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x22, 0x8d, 0x04, 0x0a, 0x0d, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71,
	...
	0x74, 0x12, 0x55, 0x0a, 0x0d, 0x6a, 0x75, 0x73, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	...
	,
	...
	0x65, 0x76, 0x69, 0x65, 0x77, 0x65, 0x72, 0x52, 0x09, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x65,
	0x72, 0x73, 0x22, 0x95, 0x01, 0x0a, 0x08, 0x52, 0x65, 0x76, 0x69, 0x65, 0x77, 0x65, 0x72, 0x12,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x73, 0x22, 0xb8, 0x02, 0x0a, 0x1c, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x41,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x12, 0x27, 0x0a, 0x0f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f,
	0x67, 0x72, 0x61, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0e, 0x61, 0x63,
	0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x47, 0x72, 0x61, 0x6e, 0x74, 0x73, 0x12, 0x1e, 0x0a, 0x0a,
	0x62, 0x72, 0x65, 0x61, 0x6b, 0x67, 0x6c, 0x61, 0x73, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08,
	...
	0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x62, 0x72, 0x65, 0x61, 0x6b, 0x67, 0x6c,
	...
	0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x20, 0x21, 0x3d, 0x20, 0x27, 0x27, 0x29, 0x22, 0x69, 0x0a,
	0x1d, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52,
	...
	0x67, 0x6e, 0x6f, 0x73, 0x74, 0x69, 0x63, 0x73, 0x22, 0x8a, 0x01, 0x0a, 0x0d, 0x4a, 0x75, 0x73,
	...
	0x61, 0x73, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x51, 0x0a, 0x0b, 0x61, 0x74, 0x74, 0x61, 0x63,
	0x68, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x63,
	...
	,
	...
	,
	...
	0x09, 0x52, 0x07, 0x73, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x2a, 0x81, 0x01, 0x0a, 0x0d, 0x52,
	...
	,
	...
	0x92, 0x01, 0x0a, 0x15, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4d, 0x79, 0x41, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x12, 0x38, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x66, 0x61, 0x74, 0x65, 0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2e, 0x76, 0x31,
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4d, 0x79, 0x41, 0x63,
	...
	0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4d, 0x79, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x04,
	0x88, 0xb5, 0x18, 0x01, 0x12, 0x83, 0x01, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x65,
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x04, 0x88, 0xb5, 0x18, 0x01, 0x12, 0x98, 0x01, 0x0a, 0x17, 0x47,
	0x65, 0x74, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x3a, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x66,
	0x61, 0x74, 0x65, 0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70,
	0x68, 0x61, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	0x66, 0x61, 0x74, 0x65, 0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2e, 0x76, 0x31, 0x61, 0x6c,
	0x70, 0x68, 0x61, 0x31, 0x2e, 0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63,
...
var file_commonfate_access_v1alpha1_access_request_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_commonfate_access_v1alpha1_access_request_proto_goTypes = []any{
	...
	(*Attachment)(nil),                      // 23: commonfate.access.v1alpha1.Attachment
	(*AttachmentSpecifier)(nil),             // 24: commonfate.access.v1alpha1.AttachmentSpecifier
	(*JustificationDetail)(nil),             // 25: commonfate.access.v1alpha1.JustificationDetail
	(*AttachmentDetail)(nil),                // 26: commonfate.access.v1alpha1.AttachmentDetail
	(*v1alpha1.EntityFilter)(nil),           // 27: commonfate.filters.v1alpha1.EntityFilter
	(*v1alpha1.BoolFilter)(nil),             // 28: commonfate.filters.v1alpha1.BoolFilter
	(*v1alpha1.IntegerFilter)(nil),          // 29: commonfate.filters.v1alpha1.IntegerFilter
	(*v1alpha1.TimeRangeFilter)(nil),        // 30: commonfate.filters.v1alpha1.TimeRangeFilter
	(v1alpha11.Order)(0),                    // 31: commonfate.entity.v1alpha1.Order
...
var file_commonfate_access_v1alpha1_access_request_proto_depIdxs = []int32{
	27, // 0: commonfate.access.v1alpha1.Filter.requested_by:type_name -> commonfate.filters.v1alpha1.EntityFilter
	27, // 1: commonfate.access.v1alpha1.Filter.closed_by:type_name -> commonfate.filters.v1alpha1.EntityFilter
	27, // 2: commonfate.access.v1alpha1.Filter.approved_by:type_name -> commonfate.filters.v1alpha1.EntityFilter
	28, // 3: commonfate.access.v1alpha1.Filter.manually_approved:type_name -> commonfate.filters.v1alpha1.BoolFilter
	28, // 4: commonfate.access.v1alpha1.Filter.auto_approved:type_name -> commonfate.filters.v1alpha1.BoolFilter
	29, // 5: commonfate.access.v1alpha1.Filter.grant_count:type_name -> commonfate.filters.v1alpha1.IntegerFilter
	30, // 6: commonfate.access.v1alpha1.Filter.requested_at:type_name -> commonfate.filters.v1alpha1.TimeRangeFilter
	30, // 7: commonfate.access.v1alpha1.Filter.approved_at:type_name -> commonfate.filters.v1alpha1.TimeRangeFilter
	30, // 8: commonfate.access.v1alpha1.Filter.closed_at:type_name -> commonfate.filters.v1alpha1.TimeRangeFilter
	30, // 9: commonfate.access.v1alpha1.Filter.activated_at:type_name -> commonfate.filters.v1alpha1.TimeRangeFilter
	31, // 10: commonfate.access.v1alpha1.QueryAccessRequestsRequest.order:type_name -> commonfate.entity.v1alpha1.Order
	...
	4,  // 12: commonfate.access.v1alpha1.QueryAccessRequestsRequest.filters:type_name -> commonfate.access.v1alpha1.Filter
	13, // 13: commonfate.access.v1alpha1.QueryMyAccessRequestsResponse.access_requests:type_name -> commonfate.access.v1alpha1.AccessRequest
	31, // 14: commonfate.access.v1alpha1.QueryMyAccessRequestsRequest.order:type_name -> commonfate.entity.v1alpha1.Order
	...
	4,  // 16: commonfate.access.v1alpha1.QueryMyAccessRequestsRequest.filters:type_name -> commonfate.access.v1alpha1.Filter
	13, // 17: commonfate.access.v1alpha1.QueryAccessRequestsResponse.access_requests:type_name -> commonfate.access.v1alpha1.AccessRequest
	13, // 18: commonfate.access.v1alpha1.GetAccessRequestResponse.access_request:type_name -> commonfate.access.v1alpha1.AccessRequest
	15, // 19: commonfate.access.v1alpha1.GetAccessRequestActionsResponse.access_request_actions:type_name -> commonfate.access.v1alpha1.AccessRequestActions
	32, // 20: commonfate.access.v1alpha1.AccessRequest.grants:type_name -> commonfate.access.v1alpha1.Grant
	33, // 21: commonfate.access.v1alpha1.AccessRequest.created_at:type_name -> google.protobuf.Timestamp
	25, // 22: commonfate.access.v1alpha1.AccessRequest.justification:type_name -> commonfate.access.v1alpha1.JustificationDetail
	34, // 23: commonfate.access.v1alpha1.AccessRequest.principal:type_name -> commonfate.access.v1alpha1.User
	14, // 24: commonfate.access.v1alpha1.AccessRequest.reviewers:type_name -> commonfate.access.v1alpha1.Reviewer
	34, // 25: commonfate.access.v1alpha1.Reviewer.user:type_name -> commonfate.access.v1alpha1.User
	1,  // 26: commonfate.access.v1alpha1.Reviewer.review_decision:type_name -> commonfate.access.v1alpha1.ReviewDecision
	35, // 27: commonfate.access.v1alpha1.ApproveAccessRequestResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	2,  // 28: commonfate.access.v1alpha1.CloseAccessRequestRequest.closing_reason:type_name -> commonfate.access.v1alpha1.ClosingReason
	35, // 29: commonfate.access.v1alpha1.CloseAccessRequestResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	35, // 30: commonfate.access.v1alpha1.ActivateAccessRequestResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	24, // 31: commonfate.access.v1alpha1.Justification.attachments:type_name -> commonfate.access.v1alpha1.AttachmentSpecifier
	3,  // 32: commonfate.access.v1alpha1.Attachment.type:type_name -> commonfate.access.v1alpha1.AttachmentType
	23, // 33: commonfate.access.v1alpha1.AttachmentSpecifier.attachment:type_name -> commonfate.access.v1alpha1.Attachment
	26, // 34: commonfate.access.v1alpha1.JustificationDetail.attachments:type_name -> commonfate.access.v1alpha1.AttachmentDetail
	3,  // 35: commonfate.access.v1alpha1.AttachmentDetail.type:type_name -> commonfate.access.v1alpha1.AttachmentType
	5,  // 36: commonfate.access.v1alpha1.AccessRequestService.QueryAccessRequests:input_type -> commonfate.access.v1alpha1.QueryAccessRequestsRequest
	7,  // 37: commonfate.access.v1alpha1.AccessRequestService.QueryMyAccessRequests:input_type -> commonfate.access.v1alpha1.QueryMyAccessRequestsRequest
	9,  // 38: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequest:input_type -> commonfate.access.v1alpha1.GetAccessRequestRequest
	11, // 39: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequestActions:input_type -> commonfate.access.v1alpha1.GetAccessRequestActionsRequest
	16, // 40: commonfate.access.v1alpha1.AccessRequestService.ApproveAccessRequest:input_type -> commonfate.access.v1alpha1.ApproveAccessRequestRequest
	20, // 41: commonfate.access.v1alpha1.AccessRequestService.ActivateAccessRequest:input_type -> commonfate.access.v1alpha1.ActivateAccessRequestRequest
	18, // 42: commonfate.access.v1alpha1.AccessRequestService.CloseAccessRequest:input_type -> commonfate.access.v1alpha1.CloseAccessRequestRequest
	8,  // 43: commonfate.access.v1alpha1.AccessRequestService.QueryAccessRequests:output_type -> commonfate.access.v1alpha1.QueryAccessRequestsResponse
	6,  // 44: commonfate.access.v1alpha1.AccessRequestService.QueryMyAccessRequests:output_type -> commonfate.access.v1alpha1.QueryMyAccessRequestsResponse
	10, // 45: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequest:output_type -> commonfate.access.v1alpha1.GetAccessRequestResponse
	12, // 46: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequestActions:output_type -> commonfate.access.v1alpha1.GetAccessRequestActionsResponse
	17, // 47: commonfate.access.v1alpha1.AccessRequestService.ApproveAccessRequest:output_type -> commonfate.access.v1alpha1.ApproveAccessRequestResponse
	21, // 48: commonfate.access.v1alpha1.AccessRequestService.ActivateAccessRequest:output_type -> commonfate.access.v1alpha1.ActivateAccessRequestResponse
	19, // 49: commonfate.access.v1alpha1.AccessRequestService.CloseAccessRequest:output_type -> commonfate.access.v1alpha1.CloseAccessRequestResponse
...
func file_commonfate_access_v1alpha1_access_request_proto_init() {
	...
	file_commonfate_access_v1alpha1_access_request_proto_msgTypes[20].OneofWrappers = []any{
		(*AttachmentSpecifier_Attachment)(nil),
		(*AttachmentSpecifier_Lookup)(nil),
	}
	file_commonfate_access_v1alpha1_access_request_proto_msgTypes[21].OneofWrappers = []any{}
	type x struct{}
