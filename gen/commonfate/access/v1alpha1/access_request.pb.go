...
var file_commonfate_access_v1alpha1_access_request_proto_depIdxs = []int32{
	...
	27, // 24: commonfate.access.v1alpha1.AccessRequest.reviewers:type_name -> commonfate.access.v1alpha1.User
	...
	28, // 27: commonfate.access.v1alpha1.CloseAccessRequestResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	28, // 28: commonfate.access.v1alpha1.ActivateAccessRequestResponse.diagnostics:type_name -> commonfate.access.v1alpha1.Diagnostic
	3,  // 29: commonfate.access.v1alpha1.AccessRequestService.QueryAccessRequests:input_type -> commonfate.access.v1alpha1.QueryAccessRequestsRequest
	5,  // 30: commonfate.access.v1alpha1.AccessRequestService.QueryMyAccessRequests:input_type -> commonfate.access.v1alpha1.QueryMyAccessRequestsRequest
	7,  // 31: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequest:input_type -> commonfate.access.v1alpha1.GetAccessRequestRequest
	9,  // 32: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequestActions:input_type -> commonfate.access.v1alpha1.GetAccessRequestActionsRequest
	13, // 33: commonfate.access.v1alpha1.AccessRequestService.ApproveAccessRequest:input_type -> commonfate.access.v1alpha1.ApproveAccessRequestRequest
	17, // 34: commonfate.access.v1alpha1.AccessRequestService.ActivateAccessRequest:input_type -> commonfate.access.v1alpha1.ActivateAccessRequestRequest
	15, // 35: commonfate.access.v1alpha1.AccessRequestService.CloseAccessRequest:input_type -> commonfate.access.v1alpha1.CloseAccessRequestRequest
	6,  // 36: commonfate.access.v1alpha1.AccessRequestService.QueryAccessRequests:output_type -> commonfate.access.v1alpha1.QueryAccessRequestsResponse
	4,  // 37: commonfate.access.v1alpha1.AccessRequestService.QueryMyAccessRequests:output_type -> commonfate.access.v1alpha1.QueryMyAccessRequestsResponse
	8,  // 38: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequest:output_type -> commonfate.access.v1alpha1.GetAccessRequestResponse
	10, // 39: commonfate.access.v1alpha1.AccessRequestService.GetAccessRequestActions:output_type -> commonfate.access.v1alpha1.GetAccessRequestActionsResponse
	14, // 40: commonfate.access.v1alpha1.AccessRequestService.ApproveAccessRequest:output_type -> commonfate.access.v1alpha1.ApproveAccessRequestResponse
	18, // 41: commonfate.access.v1alpha1.AccessRequestService.ActivateAccessRequest:output_type -> commonfate.access.v1alpha1.ActivateAccessRequestResponse
	16, // 42: commonfate.access.v1alpha1.AccessRequestService.CloseAccessRequest:output_type -> commonfate.access.v1alpha1.CloseAccessRequestResponse
