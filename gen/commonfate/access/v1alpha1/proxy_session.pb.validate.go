...
func (m *KubernetesAction) validate(all bool) error {
	...
	if m.ExecMetadata != nil {

		if all {
			switch v := interface{}(m.GetExecMetadata()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, KubernetesActionValidationError{
						field:  "ExecMetadata",
						reason: "embedded message failed validation",
						cause:  err,
					})
		...
		} else if v, ok := interface{}(m.GetExecMetadata()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
				return KubernetesActionValidationError{
					field:  "ExecMetadata",
					reason: "embedded message failed validation",
					cause:  err,
				}
...
// Validate checks the field values on KubernetesExecMetadata with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *KubernetesExecMetadata) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on KubernetesExecMetadata with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// KubernetesExecMetadataMultiError, or nil if none found.
func (m *KubernetesExecMetadata) ValidateAll() error {
	return m.validate(true)
}

func (m *KubernetesExecMetadata) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return KubernetesExecMetadataMultiError(errors)
	}

	return nil
}

// KubernetesExecMetadataMultiError is an error wrapping multiple validation
// errors returned by KubernetesExecMetadata.ValidateAll() if the designated
// constraints aren't met.
type KubernetesExecMetadataMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m KubernetesExecMetadataMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m KubernetesExecMetadataMultiError) AllErrors() []error { return m }

// KubernetesExecMetadataValidationError is the validation error returned by
// KubernetesExecMetadata.Validate if the designated constraints aren't met.
type KubernetesExecMetadataValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e KubernetesExecMetadataValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e KubernetesExecMetadataValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e KubernetesExecMetadataValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e KubernetesExecMetadataValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e KubernetesExecMetadataValidationError) ErrorName() string {
	return "KubernetesExecMetadataValidationError"
}

// Error satisfies the builtin error interface
func (e KubernetesExecMetadataValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sKubernetesExecMetadata.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = KubernetesExecMetadataValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = KubernetesExecMetadataValidationError{}
