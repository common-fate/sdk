...
const (
	AuditAction_GRANT_ACTION_UNSPECIFIED AuditAction = 0
	// Access was requested.
	AuditAction_AUDIT_ACTION_ACCESS_REQUESTED AuditAction = 1
	// Access was approved.
	AuditAction_AUDIT_ACTION_ACCESS_APPROVED AuditAction = 2
	// Access was provisioned.
	AuditAction_GRANT_ACTION_ACCESS_PROVISIONED AuditAction = 3
	// The grant was cancelled before it was activated
	AuditAction_GRANT_ACTION_ACCESS_CANCELLED AuditAction = 4
	// The grant was revoked while it was active.
	AuditAction_GRANT_ACTION_ACCESS_REVOKED AuditAction = 5
	// An error occurred.
	AuditAction_GRANT_ACTION_ERROR AuditAction = 6
	// Access was deprovisioned.
	AuditAction_GRANT_ACTION_DEPROVISIONED AuditAction = 7
)
...
var (
	AuditAction_name = map[int32]string{
		...
		1: "AUDIT_ACTION_ACCESS_REQUESTED",
		2: "AUDIT_ACTION_ACCESS_APPROVED",
		3: "GRANT_ACTION_ACCESS_PROVISIONED",
		4: "GRANT_ACTION_ACCESS_CANCELLED",
		5: "GRANT_ACTION_ACCESS_REVOKED",
...
type AuditLog struct {
	...
	Action AuditAction `protobuf:"varint,1,opt,name=action,proto3,enum=commonfate.access.v1alpha1.AuditAction" json:"action,omitempty"`
...
func (x *AuditLog) GetAction() AuditAction {
	...
	return AuditAction_GRANT_ACTION_UNSPECIFIED
}
...
var file_commonfate_access_v1alpha1_audit_logs_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0xc7, 0x02, 0x0a, 0x08, 0x41, 0x75, 0x64, 0x69, 0x74, 0x4c, 0x6f, 0x67, 0x12, 0x3f,
	...
	0x36, 0x0a, 0x05, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20,
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x66, 0x61, 0x74, 0x65, 0x2e, 0x61, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72,
	0x52, 0x05, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x3b, 0x0a, 0x0b, 0x6f, 0x63, 0x63, 0x75, 0x72,
	...
	0x65, 0x64, 0x41, 0x74, 0x12, 0x38, 0x0a, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x66, 0x61,
	0x74, 0x65, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x7a, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61,
	0x31, 0x2e, 0x55, 0x49, 0x44, 0x52, 0x07, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x12, 0x18,
	...
	,
	...
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x32, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x66, 0x61, 0x74, 0x65, 0x2e, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x2e, 0x76, 0x31, 0x61,
	0x6c, 0x70, 0x68, 0x61, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x75, 0x64, 0x69, 0x74,
	0x4c, 0x6f, 0x67, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x84,
...
var file_commonfate_access_v1alpha1_audit_logs_proto_goTypes = []interface{}{
	(AuditAction)(0),               // 0: commonfate.access.v1alpha1.AuditAction
...
var file_commonfate_access_v1alpha1_audit_logs_proto_depIdxs = []int32{
	...
	0, // 2: commonfate.access.v1alpha1.AuditLog.action:type_name -> commonfate.access.v1alpha1.AuditAction
	...
	4, // 5: commonfate.access.v1alpha1.AuditLog.targets:type_name -> commonfate.authz.v1alpha1.UID
	7, // 6: commonfate.access.v1alpha1.AuditLog.context:type_name -> google.protobuf.Struct
	1, // 7: commonfate.access.v1alpha1.AuditLogService.QueryAuditLogs:input_type -> commonfate.access.v1alpha1.QueryAuditLogsRequest
	2, // 8: commonfate.access.v1alpha1.AuditLogService.QueryAuditLogs:output_type -> commonfate.access.v1alpha1.QueryAuditLogsResponse
