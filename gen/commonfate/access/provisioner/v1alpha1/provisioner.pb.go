...
type ProvisionRequest struct {
	...
	RequestId *v1alpha1.EID `protobuf:"bytes,7,opt,name=request_id,json=requestId,proto3" json:"request_id,omitempty"`
}
...
func (x *ProvisionRequest) GetRequestId() *v1alpha1.EID {
	if x != nil {
		return x.RequestId
	}
	return nil
...
var file_commonfate_access_provisioner_v1alpha1_provisioner_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xee, 0x03, 0x0a,
	...
	0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3e, 0x0a,
	...
	0x49, 0x44, 0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0x5f, 0x0a,
...
var file_commonfate_access_provisioner_v1alpha1_provisioner_proto_depIdxs = []int32{
	...
	2, // 6: commonfate.access.provisioner.v1alpha1.ProvisionRequest.request_id:type_name -> commonfate.entity.v1alpha1.EID
