...
import (
	...
	context "context"
	errors "errors"
	v1alpha1 "github.com/common-fate/sdk/gen/commonfate/cloud/support/v1alpha1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SupportServiceName = "commonfate.cloud.support.v1alpha1.SupportService"
)
...
const (
	...
	SupportServiceContactProcedure = "/commonfate.cloud.support.v1alpha1.SupportService/Contact"
	...
	SupportServiceGetAttachmentUploadURLProcedure = "/commonfate.cloud.support.v1alpha1.SupportService/GetAttachmentUploadURL"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	supportServiceServiceDescriptor                      = v1alpha1.File_commonfate_cloud_support_v1alpha1_support_proto.Services().ByName("SupportService")
...
// SupportServiceClient is a client for the commonfate.cloud.support.v1alpha1.SupportService
// service.
...
// commonfate.cloud.support.v1alpha1.SupportService service. By default, it uses the Connect
...
// Contact calls commonfate.cloud.support.v1alpha1.SupportService.Contact.
...
// commonfate.cloud.support.v1alpha1.SupportService.GetAttachmentUploadURL.
...
// commonfate.cloud.support.v1alpha1.SupportService service.
...
func NewSupportServiceHandler(svc SupportServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/commonfate.cloud.support.v1alpha1.SupportService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSupportServiceHandler) Contact(context.Context, *connect.Request[v1alpha1.ContactRequest]) (*connect.Response[v1alpha1.ContactResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("commonfate.cloud.support.v1alpha1.SupportService.Contact is not implemented"))
}
...
func (UnimplementedSupportServiceHandler) GetAttachmentUploadURL(context.Context, *connect.Request[v1alpha1.GetAttachmentUploadURLRequest]) (*connect.Response[v1alpha1.GetAttachmentUploadURLResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("commonfate.cloud.support.v1alpha1.SupportService.GetAttachmentUploadURL is not implemented"))
}
